...
define("CLOCK_AD_L4", "Nastavení menu s hodinami");
define("CLOCK_AD_L5", "AM/PM");
define("CLOCK_AD_L6", "Zaškrtněte pro US formát hodin (0-12 AM/PM). Nechte nezaškrtnuto pro standardní 24 hodinový formát");
define("CLOCK_AD_L7", "Předpony datumu");
