...
|        Last Modified: 2017/11/21 22:16:36
|
|        $URL: https://github.com/oxigeno2/e107 $
|        $Revision: 2.1.7 $
|        $Id: 2017/11/21 22:16:36 $
|        $Author: OxigenO2 $
+---------------------------------------------------------------+
*/
...
define("EXTLAN_26", "posunout nahoru");
define("EXTLAN_27", "Potvrďte smazání");
...
define("EXTLAN_40", "Kategorie byla vytvořena");
define("EXTLAN_41", "Kategorie byla smazána");
define("EXTLAN_42", "Upravit kategorii");
define("EXTLAN_43", "Kategorie upravena");
...
define("EXTLAN_51", "Zde lze použít jakýkoliv validní (dle W3C) parametr<br />např. <i><b>class='tbox' size='40' maxlength='80'</i></b>");
...
define("EXTLAN_81", "Přidat vlastní pole");
define("EXTLAN_82", "Hodnota");
define("EXTLAN_83", "Pole");
define("EXTLAN_84", "Nápověda");
define("EXTLAN_86", "Rozšířené pole uživatele byl smazán z tabulky");
define("EXTLAN_87", "Řazení hodnot");
define("EXTLAN_HELP_1", "<b><i>Parametry:</i></b><br />size - velikost pole<br />maxlength - maximální délka pole<br /><br />class - třída css pro pole<br />style - řetězec stylu css<br /><br />regex - regulární výraz pro ověření<br />regexfail - text při selhání ověření regulárním výrazem");
define("EXTLAN_HELP_2", "Tento text bude nápověda pro tlačítka výběru (radio)");
define("EXTLAN_HELP_3", "Tento text je nápovědou pro vysouvací nabídku (drop-down)");
...
define("EXTLAN_HELP_5", "Tento text bude nápovědou pro vstupní pole volného textu");
