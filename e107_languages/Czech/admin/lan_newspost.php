...
define("NWSLAN_55", "Aktualizovat kategorii novinek");
define("NWSLAN_56", "Vytvořit kategorii zpráv");
...
define("NWSLAN_120", "Text, který se bude zobrazovat nad formulářem pro vkládání uživatelských novinek.");
define("NWSLAN_121", "Nalezeno nic pro %s");
...
define("LAN_NEWS_52", "Obecné informace");
define("LAN_NEWS_53", "Pokročilé možnosti");
define("LAN_NEWS_55", "Údržba");
define("LAN_NEWS_57", "Pokračovat");
define("LAN_NEWS_59", "Údržba novinek");
define("LAN_NEWS_60", "Komentářů celkem");
...
define("LAN_NEWS_64", "Staré předložené");
define("LAN_NEWS_65", "Zvolte pro tuto kategorii jedinečný řetězec adresy SEF");
define("LAN_NEWS_67", "Zavřít");
define("LAN_NEWS_68", "Předložená novinka");
define("LAN_NEWS_69", "Výchozí oblast");
define("LAN_NEWS_70", "Výchozí oblast - Titulek");
define("LAN_NEWS_71", "Výchozí oblast - Titulek / Shrnutí");
define("LAN_NEWS_72", "Boční panel - Ostatní novinky");
...
define("LAN_NEWS_91", "Limit zobrazení seznamu na stránku");
define("LAN_NEWS_92", "např. news.php?all nebo news.php?cat.1 nebo news.php?tag=xxx");
define("LAN_NEWS_93", "Seznam zobrazení obsahu");
define("LAN_NEWS_94", "Položky přiřazené těmto šablonám se zobrazí v seznamu.");
define("LAN_NEWS_95", "Další novinka využívá adresu SEF URL: [x]");
define("LAN_NEWS_96", "Schválit");
define("LAN_NEWS_97", "Menu Mřížka novinek");
define("LAN_NEWS_98", "Ping služby");
define("LAN_NEWS_99", "Přijmout pouze obrázky větší než");
define("LAN_NEWS_100", "Jakákoliv velikost");
define("LAN_NEWS_101", "Vkládání novinek");
define("LAN_NEWS_102", "Otevřít na nové kartě");
define("LAN_NEWS_103", "E-mailové oznámení");
define("LAN_NEWS_104", "Vyvolat upozornění e-mailem po odeslání tohoto formuláře.");
define("LAN_NEWS_105", "Upozornění na e-mail spuštěno!");
define("LAN_NEWS_106", "Viditelnost položky musí být 'všechny', aby fungovalo e-mailové oznámení.");
define("LAN_NEWS_107", "Kontrola stavu pingu");
define("LAN_NEWS_108", "Adresa SEF URL se liší od názvu vaší novinky.");
