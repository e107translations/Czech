...
|        Last Modified: 2015/12/20 19:54:08
|
|        $Author: Oxigen $
+---------------------------------------------------------------+
*/
...
define("ONLINE_EL16", "Informace není k dispozici.");
define("CLASSRESTRICTED", "Stránka s omezeným přístupem");
define("CHAT", "Chat");
define("DOWNLOAD", "Stažení");
...
define("PRINTPAGE", "Tisknout");
define("LOGIN", "Přihlašuji");
define("SEARCH", "Hledám");
define("STATS", "Statistiky stránek");
define("SUBMITNEWS", "Odeslat novinku");
...
define("SUBCONTENT", "uložit článek");
define("TOP", "Nejaktivnější uživatelé/Témata s nejvíce zobrazeními");
define("ADMINAREA", "Administrace");
define("BUGTRACKER", "Databáze chyb");
