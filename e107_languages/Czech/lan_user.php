...
define("LAN_USER_36", "Klikněte zde pro zobrazení komentářů uživatele");
define("LAN_USER_37", "Klikněte zde pro zobrazení příspěvků do fóra");
define("LAN_USER_38", "Klikněte zde pro aktualizaci vašich údajů");
define("LAN_USER_39", "Klikněte zde pro editaci uživatel");
define("LAN_USER_40", "předchozí uživatel");
define("LAN_USER_41", "další uživatel");
define("LAN_USER_42", "bez fotografie");
define("LAN_USER_43", "smazat fotografii");
define("LAN_USER_44", "Různé");
define("LAN_USER_45", "Sestupně");
define("LAN_USER_46", "Vzestupně");
define("LAN_USER_49", "Nejsou k dispozici informace pro tohoto uživatele, protože neni registrován v");
define("LAN_USER_50", "Profil uživatele");
define("LAN_USER_51", "To není platný uživatel.");
define("LAN_USER_52", "Registrovaní uživatelé");
define("LAN_USER_53", "Zatím žádní registrovaní uživatelé.");
define("LAN_USER_54", "Úroveň");
define("LAN_USER_55", "Nemáte oprávnění k prohlížení této stránky.");
define("LAN_USER_56", "Registrovaní uživatelé:");
define("LAN_USER_57", "Seřazení:");
define("LAN_USER_58", "Uživatel");
define("LAN_USER_59", "Registrován");
define("LAN_USER_60", "Emailová adresa:");
define("LAN_USER_62", "Poslat soukromou správu");
define("LAN_USER_63", "Skutečné jméno:");
define("LAN_USER_64", "Statistiky");
define("LAN_USER_65", "Poslední návštěva");
define("LAN_USER_66", "Navštíveno stránek od registrace");
define("LAN_USER_67", "Příspěvků v Chatboxu");
